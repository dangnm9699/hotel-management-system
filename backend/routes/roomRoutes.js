...
roomRouter.get('/searchname', roomController.searchRoomName)
roomRouter.get('/getidleroombytype', roomController.getIdleRoomByType)
roomRouter.get('/counts', roomController.getRoomCountByStatusWithType)
